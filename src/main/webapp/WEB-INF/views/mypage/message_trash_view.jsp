        ...
        <div class="con_middle">
            ...
            <div class="content">
                ...
                <div align="right" style="margin-bottom: 15px">
               		<form action="message_trash_view" method="post">
										...
										<td>
											<div style="width:900px;">
												...
												<div style="padding-bottom:5px;border-bottom:1px solid black;font-size:8px;width:900px;">
													<span class="underText">보낸사람 : ${meo.transempno} | ||받는사람 ${meo.receiveempno}</span>
													<span class="underText">
														<c:if test="${today == sdf1date}">${sdf2date}</c:if>
														<c:if test="${today != sdf1date}">${sdf1date}</c:if>
													</span>
													<c:if test="${meo.attachedfile != null}"><span><img src="${path}/images/clip.png" style="width:15px;"></span></c:if>
												</div>
											</div>
										</td>
									</tr>
